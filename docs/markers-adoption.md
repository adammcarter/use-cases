...
| Use-case row | Code |
|---|---|
| `evidence.ledger.crash_durable_ledger_writes` | `packages/ucm-core/src/durableWrite.ts` :: `fsyncBestEffortForTemp` (explicit span) |
...
`packages/ucm-core/test/markers/skipBuildDirs.test.ts`.
