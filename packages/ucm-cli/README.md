...
Command-line interface for **Use Case Matrix (UCM)** — a repo-local, agent-facing
...
See the
[CLI reference](https://github.com/adammcarter/presentation-skills/blob/main/docs/cli.md)
and the
