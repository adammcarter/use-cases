...
// skill can never be silently dropped from one surface. (A retired skill once
// was: host projection hard-coded a 3-item list that omitted it.)
export const CANONICAL_SKILLS = ["use-cases", "showcase", "walkthrough", "init", "use-case-driven-development"] as const;
