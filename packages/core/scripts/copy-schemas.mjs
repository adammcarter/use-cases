...
const markerSchemaSource = join(repoRoot, "packages/core/src/markers/schemas");
const markerSchemaDestination = join(repoRoot, "packages/core/dist/markers/schemas");
const lockDir = join(repoRoot, "packages/core/.copy-schemas.lock");
