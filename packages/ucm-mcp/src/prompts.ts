...
// authoring `presentation-skills.yml` + a `use-cases/` tree. `prove` is
        ...
        messages: [
          userMessage(
            [
              ...
              "",
              "There is no `ucm init` command — a workspace is adopted by authoring two things by hand:",
              `1. A workspace config \`presentation-skills.yml\` at the repo root (declares data_root, use_cases_dir, component_id, and optional verifiers/release_gate).`,
