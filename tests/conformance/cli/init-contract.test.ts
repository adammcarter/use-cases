// `use-cases init` contract test (public-v1 Phase 5 onboarding).
//
...
//   1. `use-cases init` writes a workspace config + an example matrix file, and the
//      scaffolded workspace IMMEDIATELY passes `use-cases matrix validate`.
